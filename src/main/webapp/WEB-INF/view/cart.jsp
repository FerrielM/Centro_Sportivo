  ...
  <div class="container mt-4">
	...
	<h4 class="mb-3 text-white fw-bold text-center">Il tuo carrello</h4>
      <table class="table table-dark table-striped my-4 w-75 mx-auto">
      	...
      	<tr>
      		<th colspan="2">${article.nome}</th>
      		<th><fmt:formatNumber value="${article.prezzo}" maxFractionDigits="2" minFractionDigits="2" type="currency" currencyCode="EUR" currencySymbol="€"/></th>
      	</tr>
      	</c:forEach>
