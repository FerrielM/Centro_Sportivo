...
<span class="ms-3">Centro Sportivo Big Jim</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto me-2 mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<spring:url value="/index"/>"><span class="text-jim">Home</span></a>
        </li>
        
        <li class="nav-item">
          <a class="nav-link" href="<spring:url value="/corsi"/>"><span class="text-jim">Corsi</span></a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="<spring:url value="/login"/>"><span class="text-jim">Login</span></a>
        </li>
